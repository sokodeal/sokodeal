        ...
        {activeTab === 'abonnement' && (
          <div>
            ...
            <div style={{display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:'16px'}}>
              {[
                { name:'Gratuit', price:'0', period:'Pour toujours', color:'#6b7c6e', features:['3 annonces max','Photos limitées','Support standard'], current:true },
                { name:'Pro ⭐', price:'15 000', period:'par mois', color:'#1a7a4a', features:['Annonces illimitées','5 photos par annonce','Badge Pro','1 boost offert/mois','Support prioritaire'], popular:true },
                { name:'Agence 🏢', price:'50 000', period:'par mois', color:'#1a3a5c', features:['Tout du Pro','Page agence dédiée','5 boosts/mois','Tableau de bord avancé','Support dédié'] },
              ].map((plan, i) => (
